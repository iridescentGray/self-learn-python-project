...
if __name__ == '__main__':
    ...
    line_chart_in_the_same_coordinate = line_chart_in_the_same_coordinate_figure.add_subplot(2, 2, 1)
    ...
    line_chart_in_the_same_coordinate.plot(x, y2, linewidth=2, marker='*', color='blue')
    # 显示绘图
    plt.show()
