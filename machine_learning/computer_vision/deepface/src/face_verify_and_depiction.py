...
result = DeepFace.verify(
    "machine_learning/computer_vision/deepface/data/face/yu1.jpg",
    "machine_learning/computer_vision/deepface/data/face/yu2.jpg",
)
pprint(result)
...
im1 = cv2.imread("machine_learning/computer_vision/deepface/data/face/yu1.jpg")
im2 = cv2.imread("machine_learning/computer_vision/deepface/data/face/yu2.jpg")
cv2.rectangle(
    im1,
